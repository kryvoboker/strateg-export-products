...
return new class extends Migration
{
    ...
    {
        Schema::create('product_delete_batches', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('source_type', 100)
                ->nullable(false)
                ->default(ProductDeleteBatchesSourceTypeEnum::EXCEL_FILE->value)
                ->index()
            ...
            $table->string('status', 100)
                ->nullable(false)
                ->default(ProductDeleteBatchesStatusEnum::NEW->value)
                ->index()
