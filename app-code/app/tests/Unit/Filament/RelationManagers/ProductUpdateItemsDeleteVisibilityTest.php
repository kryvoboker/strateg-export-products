...
class ProductUpdateItemsDeleteVisibilityTest extends TestCase
{
    ...
    public function test_delete_action_visibility_and_shop_options_depend_on_external_product_id(): void
    {
        ...
        $manager = new ProductUpdateItemsRelationManager();
        $record_with_external_id = new ProductUpdateItem(['product_id' => 1]);
        $record_without_external_id = new ProductUpdateItem(['product_id' => 2]);
    ...
    private function invokeHasExternalProductIdForRecord(ProductUpdateItemsRelationManager $manager, ProductUpdateItem $record): bool
    {
        $method = new ReflectionMethod(ProductUpdateItemsRelationManager::class, 'hasExternalProductIdForRecord');
     ...
     */
    private function invokeResolveDeleteShopOptionsForRecord(ProductUpdateItemsRelationManager $manager, ProductUpdateItem $record): array
    {
        $method = new ReflectionMethod(ProductUpdateItemsRelationManager::class, 'resolveDeleteShopOptionsForRecord');
